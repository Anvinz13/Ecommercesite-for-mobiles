...
{
    public partial class OrginalAccounts : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (n < r)
            {
                Label10.Text = "No enough balance";
            }
            else
            {
                ...
                int y = obj1.amountreduce(TextBox1.Text, uid, yy);
                Label10.Text = "Payment Successfull";
            }
        }
    }
}