<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Editproduct.aspx.cs" Inherits="Ecommercesite.Editproduct" %>


<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Maxtho Mobiles | Edit Products</title>
    ...
    <style>
        ...
        /* Neon Button (used for both Home & Logout now) */
        .logout-btn {
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="page-header">
            <h1>Edit Products</h1>
            <p>Update or modify your product listings below.</p>
        </div>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Image">
                        <ItemTemplate>
                            <img src='<%# Eval("Product_image") %>' alt="Product" width="80" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:FileUpload ID="FileUpload2" runat="server" />
                            <asp:HiddenField ID="HiddenField2" runat="server" Value='<%# Bind("Product_image") %>' />
                            <asp:Image ID="Image2" runat="server" ImageUrl='<%# Bind("Product_image") %>' Width="100px" Height="100px" />
                        </EditItemTemplate>
                    </asp:TemplateField>
